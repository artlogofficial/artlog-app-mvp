...
class NowCheckinPage extends StatefulWidget {
  @override
  _NowCheckinPageState createState() => _NowCheckinPageState();
}

class _NowCheckinPageState extends State<NowCheckinPage> {
